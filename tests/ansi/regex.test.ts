...
Deno.test('ANSI Regular Expression', async (s) => {
    ...
    await s.step('Styles', async (t) => {
        ...
        await t.step('italic', () => check('\u001b[3mItalic\u001b[22m'))
        await t.step('underline', () => check('\u001b[4mUnderline\u001b[22m'))
        await t.step('blinking', () => check('\u001b[5mBlinking\u001b[22m'))
        await t.step('inverse', () => check('\u001b[6mInverse\u001b[22m'))
        await t.step('hidden', () => check('\u001b[7mHidden\u001b[22m'))
        await t.step('strikethrough', () => check('\u001b[8mStrikethrough\u001b[22m'))
    })
